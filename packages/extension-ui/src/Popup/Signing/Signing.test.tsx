...
import type { SigningRequest } from '@axia-js/extension-base/background/types';
...
import { alphanetMetadata } from './metadataMock';
import Qr from './Qr';
  ...
  describe('Request rendering', () => {
    it('correctly displays request 1', () => {
      ...
      expect(wrapper.find(Extrinsic).find('td.data').map((el): string => el.text())).toEqual([
        'https://axia.js.org/apps/?rpc=wss%3A%2F%2Falphanet-rpc.axia.io#/accounts',
        'AlphaNet',
        '45',
        '3',
