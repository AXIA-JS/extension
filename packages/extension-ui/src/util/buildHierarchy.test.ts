...
import type { AccountJson, AccountWithChildren } from '@axia-js/extension-base/background/types';
...
describe('Use Account Hierarchy', () => {
  ...
  test('sorts accounts by network', () => {
    testHierarchy(
      [{ address: 'b', genesisHash: genesisExample.AXIALUNAR }, { address: 'a', genesisHash: genesisExample.AXIA }, { address: 'c', genesisHash: genesisExample.AXIALUNAR }],
      [{ address: 'b', genesisHash: genesisExample.AXIALUNAR }, { address: 'c', genesisHash: genesisExample.AXIALUNAR }, { address: 'a', genesisHash: genesisExample.AXIA }]
    );
  });

  test('sorts accounts by network and name', () => {
    testHierarchy(
      [{ address: 'b', genesisHash: genesisExample.AXIALUNAR, name: 'b-last-axialunar' }, { address: 'a', genesisHash: genesisExample.AXIA }, { address: 'c', genesisHash: genesisExample.AXIALUNAR, name: 'a-first-axialunar' }],
      [{ address: 'c', genesisHash: genesisExample.AXIALUNAR, name: 'a-first-axialunar' }, { address: 'b', genesisHash: genesisExample.AXIALUNAR, name: 'b-last-axialunar' }, { address: 'a', genesisHash: genesisExample.AXIA }]
    );
  });
