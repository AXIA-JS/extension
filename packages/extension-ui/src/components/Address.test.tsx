...
import type { IconTheme } from '@axia-js/react-identicon/types';
...
import { alphanetMetadata } from '../Popup/Signing/metadataMock';
...
const externalAccount = { address: '5EeaoDj4VDk8V6yQngKBaCD5MpJUCHrhYjVhBjgMHXoYon1s', expectedIconTheme: 'axia', isExternal: true, name: 'External Account', type: 'sr25519' } as AccountJson;
...
const accounts = [
  { address: '5HSDXAC3qEMkSzZK377sTD1zJhjaPiX5tNWppHx2RQMYkjaJ', expectedIconTheme: 'axia', name: 'ECDSA Account', type: 'ecdsa' },
  { address: '5FjgD3Ns2UpnHJPVeRViMhCttuemaRXEqaD8V5z4vxcsUByA', expectedIconTheme: 'axia', name: 'Ed Account', type: 'ed25519' },
  { address: '5Ggap6soAPaP5UeNaiJsgqQwdVhhNnm6ez7Ba1w9jJ62LM2Q', expectedIconTheme: 'axia', name: 'Parent Sr Account', type: 'sr25519' },
  { address: '0xd5D81CD4236a43F48A983fc5B895975c511f634D', expectedIconTheme: 'ethereum', name: 'Ethereum', type: 'ethereum' },
  { ...externalAccount },
  { ...hardwareAccount }
] as AccountTestJson[];

// With AlphaNet genesis Hash
...
describe('Address', () => {
  ...
  describe('Encoding and label based on Metadata', () => {
    ...
    it('shows alphanet label with the correct color', () => {
      ...
      expect(bannerChain.prop('style')?.backgroundColor).toEqual(alphanetMetadata.color);
    });
