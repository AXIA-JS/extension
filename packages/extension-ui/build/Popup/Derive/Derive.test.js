...
import Derive from "./index.js"; // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment,@typescript-eslint/no-unsafe-call
...
describe('Derive', () => {
  const mountComponent = async (locked = false, account = 1) => {
    ...
    const wrapper = mount( /*#__PURE__*/_jsx(MemoryRouter, {
      initialEntries: [`/account/derive/${accounts[account].address}`],
      children: /*#__PURE__*/_jsx(ActionContext.Provider, {
        value: onActionStub,
