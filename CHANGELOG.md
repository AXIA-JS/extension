...
- Bump `@axia-js/api` to `5.5.1`
- Bump `@axia-js/util` to `7.2.1`
...
- Bump `@axia-js/api` to `5.3.1`
- Bump `@axia-js/util` to `7.1.1`
...
- Bump `@axia-js/api` to `5.0.1`
- Bump `@axia-js/util` to `7.0.1`
...
- Bump `@axia-js/api` to `4.17.1`
- Bump `@axia-js/util` to `6.11.1`
...
- Bump `@axia-js/api` to `4.16.1`
- Bump `@axia-js/util` to `6.10.1`
...
- Bump `@axia-js/api` to `4.15.1`
- Bump `@axia-js/util` to `6.9.1`
...
- Bump `@axia-js/api` to `4.14.1`
- Bump `@axia-js/util` to `6.8.1`
...
**Important** Not published to the stores, just made available to ensure users can have access to a version that uses the latest `@axia-js/{api, util}`

Changes:

- Bump `@axia-js/api` to `4.12.1`
- Bump `@axia-js/util` to `6.6.1`
...
- Bump `@axia-js/api` & `@axia-js/util` to latest released versions
...
- Use `@axia-js/networks` for known ss58 formats/genesis (Thanks to https://github.com/Tbaut)
...
- Latest upstream axia-js dependencies
...
- Update metadata for latest AXIALunar
...
- Add latest metadata for the AXIALunar network
...
- Integrate latest @axia-js/util, @axia-js/ui & @axia-js/api dependencies
...
- Update the axia-js/api version to 0.90.1, the first non-beta version with full support for AXIALunar
...
- Updated the underlying axia-js/api version to support the most-recent signing payload extensions, as will be available on AXIALunar
...
- Change the injected Signer interface to support the upcoming AXIALunar transaction format
...
- Cater for the setting of multiple network prefixes, e.g. AXIALunar
