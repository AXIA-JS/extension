...
import type { Injected, InjectedAccount, InjectedWindow } from '@axia-js/extension-inject/types';
import type { SignerPayloadRaw, SignerResult } from '@axia-js/types/types';
