...
import { alphanetMetadata } from "./metadataMock.js";
import Qr from "./Qr.js";
import Request from "./Request/index.js";
import TransactionIndex from "./TransactionIndex.js";
import Signing from "./index.js"; // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment,@typescript-eslint/no-unsafe-call
...
describe('Signing requests', () => {
  ...
  function MockRequestsProvider() {
    ...
    return /*#__PURE__*/_jsx(SigningReqContext.Provider, {
      value: requests,
      children: /*#__PURE__*/_jsx(Signing, {})
    });
  }
  ...
  const mountComponent = async () => {
    ...
    wrapper = mount( /*#__PURE__*/_jsx(ActionContext.Provider, {
      ...
      children: /*#__PURE__*/_jsx(ThemeProvider, {
        theme: themes.dark,
        children: /*#__PURE__*/_jsx(MockRequestsProvider, {})
      })
    }));
  ...
  describe('Request rendering', () => {
    it('correctly displays request 1', () => {
      ...
      expect(wrapper.find(Extrinsic).find('td.data').map(el => el.text())).toEqual(['https://axia.js.org/apps/?rpc=wss%3A%2F%2Falphanet-rpc.axia.io#/accounts', 'AlphaNet', '45', '3', `balances.transferKeepAlive(dest, value)[
  ...
  "123.0000 WND"
    ...
    it('correctly displays request 2', async () => {
      ...
      expect(wrapper.find(Extrinsic).find('td.data').map(el => el.text())).toEqual(['https://axia.js.org/apps', 'AlphaNet', '45', '3', `balances.transfer(dest, value)[
