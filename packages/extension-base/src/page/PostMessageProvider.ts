...
import type { InjectedProvider, ProviderList, ProviderMeta } from '@axia-js/extension-inject/types';
import type { ProviderInterfaceEmitCb, ProviderInterfaceEmitted } from '@axia-js/rpc-provider/types';
...
// Same as https://github.com/axia-js/api/blob/57ca9a9c3204339e1e1f693fcacc33039868dc27/packages/rpc-provider/src/ws/Provider.ts#L17
