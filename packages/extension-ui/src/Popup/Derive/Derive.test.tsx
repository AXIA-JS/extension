...
import type { AccountJson, ResponseDeriveValidate } from '@axia-js/extension-base/background/types';
...
const accounts = [
  ...
  { address: '5GYmFzQCuC5u3tQNiMZNbFGakrz3Jq31NmMg4D2QAkSoQ2g5', genesisHash: alphanetGenesis, name: 'B', type: 'sr25519' },
