...
import type { InjectedAccount, InjectedMetadataKnown, MetadataDef, ProviderMeta } from '@axia-js/extension-inject/types';
...
import type { SubjectInfo } from '@axia-js/ui-keyring/observable/types';
