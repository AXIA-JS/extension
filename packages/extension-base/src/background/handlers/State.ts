...
import type { MetadataDef, ProviderMeta } from '@axia-js/extension-inject/types';
import type { JsonRpcResponse, ProviderInterface, ProviderInterfaceCallback } from '@axia-js/rpc-provider/types';
